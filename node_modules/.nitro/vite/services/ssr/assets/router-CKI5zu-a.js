...
import { ArrowLeft, Ticket, MapPin, Users, Ellipsis, Check, Upload, Hash, QrCode, FileText, Gift, XCircle, ShieldAlert, AlertTriangle, CheckCircle2, Search, ScanLine, X, Send, Copy, WalletCards, Navigation, DoorOpen, ShoppingBag, Fingerprint, LockKeyhole, ShieldCheck, CalendarDays, Minus, Plus, ChevronLeft, ChevronRight, RefreshCw, ArrowRight, Train, Bus, Car, Utensils, HeartPulse, Accessibility, Bell, Info, BadgeCheck, Star, Clock, Languages, Sparkles, Flame, Trophy, Truck, ShoppingCart, BadgePercent, Siren, Phone, UserRoundSearch, BadgeHelp, FileWarning, Hospital, Pill, CircleHelp, Handshake, Hotel, Crown, LifeBuoy, IdCard, Camera, User, LogIn, Mail, EyeOff, Eye, UserPlus, Globe, Activity, Zap } from "lucide-react";
...
function Logo({ className = "" }) {
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-2 ${className}`, children: [
    /* @__PURE__ */ jsx("div", { className: "relative h-8 w-8 rounded-lg bg-gradient-to-br from-primary to-primary-glow grid place-items-center glow-primary", children: /* @__PURE__ */ jsx("div", { className: "h-3 w-3 rounded-sm bg-background rotate-45" }) }),
    /* @__PURE__ */ jsxs("span", { className: "font-display font-semibold tracking-tight text-lg", children: [
      "Fan",
      /* @__PURE__ */ jsx("span", { className: "text-primary-glow", children: "Pass" })
    ] })
  ] });
}
function TopBar({ onProfileClick }) {
  const { avatarInitials } = useAuth();
  return /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs(
      Link,
      {
        to: "/",
...
function BottomNav({
  ...
  return /* @__PURE__ */ jsx("nav", { className: "fixed bottom-0 inset-x-0 z-40 pb-4 pt-2 px-3", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-md glass rounded-2xl px-2 py-2 flex items-center justify-between shadow-elevated", children: items.map((it) => {
    ...
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          active && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-primary rounded-xl glow-primary -z-0" }),
          /* @__PURE__ */ jsx(it.icon, { className: `h-5 w-5 relative z-10` }),
          /* @__PURE__ */ jsx("span", { className: "label-xs relative z-10", children: it.label })
        ]
      },
      it.id
    );
      ...
      children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: cells.map((on, i) => /* @__PURE__ */ jsx(
              "div",
              {
        ...
        ["top-2 left-2", "top-2 right-2", "bottom-2 left-2"].map((p) => /* @__PURE__ */ jsx(
          "div",
          {
            className: `absolute ${p} h-8 w-8 border-[3px] border-[#0D1F3C] rounded-md bg-white`,
            children: /* @__PURE__ */ jsx("div", { className: "absolute inset-1 bg-[#0D1F3C] rounded-sm" })
          },
          p
        )),
        /* @__PURE__ */ jsx("div", { className: "absolute inset-3 overflow-hidden rounded-lg pointer-events-none", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 h-1/3 bg-gradient-to-b from-transparent via-primary/40 to-transparent animate-scan" }) })
      ]
    }
  );
}
function SectionTitle({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: eyebrow }),
    /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold mt-1", children: title })
  ] });
}
function ImportTicketView({
  ...
  if (success) {
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "h-20 w-20 rounded-full bg-success/15 grid place-items-center", children: /* @__PURE__ */ jsx(Check, { className: "h-10 w-10 text-success" }) }),
      /* @__PURE__ */ jsx("h2", { className: "font-display text-xl font-semibold", children: "Billet importé !" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Redirection vers votre wallet..." })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: onBack,
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-8 pb-8 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-16 w-16 mx-auto place-items-center rounded-2xl bg-primary/15 mb-4", children: /* @__PURE__ */ jsx(Upload, { className: "h-8 w-8 text-primary-glow" }) }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Importer un billet" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Billet acheté ailleurs ? Importez-le dans votre wallet FanPass." })
      ] }),
      error && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-destructive/15 text-destructive px-4 py-3 text-sm", children: error }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 rounded-2xl bg-white/5 p-1", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: () => setTab("ref"),
      ...
      tab === "ref" ? /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(FileText, { className: "h-6 w-6 text-primary-glow" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: "Référence de billet" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Saisissez la référence reçue par email ou sur votre billet officiel." })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "input",
      ...
      ] }) : /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(QrCode, { className: "h-6 w-6 text-primary-glow" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: "Scanner un QR" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Collez les données du QR code scanné depuis votre billet officiel." })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "textarea",
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(QrCode, { className: "h-8 w-8" }),
              /* @__PURE__ */ jsx("span", { children: "Scanner avec la caméra" })
            ]
          }
        )
      ] }),
...
function AcceptTransferView({
  ...
  if (success) {
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "h-20 w-20 rounded-full bg-success/15 grid place-items-center", children: /* @__PURE__ */ jsx(Check, { className: "h-10 w-10 text-success" }) }),
      /* @__PURE__ */ jsx("h2", { className: "font-display text-xl font-semibold", children: "Billet reçu !" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Le billet a été ajouté à votre wallet." })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-12 pb-8 flex flex-col justify-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-16 w-16 mx-auto place-items-center rounded-2xl bg-success/15 mb-4", children: /* @__PURE__ */ jsx(Gift, { className: "h-8 w-8 text-success" }) }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Accepter un billet" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Quelqu'un vous a transféré un billet ? Saisissez le code reçu." })
      ] }),
      error && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-destructive/15 text-destructive px-4 py-3 text-sm mb-4", children: error }),
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 space-y-4", children: [
        /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block", children: "Code de transfert" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
...
function ScanView({ onBack }) {
  ...
  const resultIcon = {
    access_granted: /* @__PURE__ */ jsx(CheckCircle2, { className: "h-12 w-12 text-success" }),
    wrong_gate: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-12 w-12 text-primary-glow" }),
    already_used: /* @__PURE__ */ jsx(XCircle, { className: "h-12 w-12 text-destructive" }),
    invalid_ticket: /* @__PURE__ */ jsx(ShieldAlert, { className: "h-12 w-12 text-destructive" }),
    ticket_cancelled: /* @__PURE__ */ jsx(XCircle, { className: "h-12 w-12 text-destructive" })
  }[result?.result ?? ""] ?? /* @__PURE__ */ jsx(Search, { className: "h-12 w-12 text-muted-foreground" });
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs(
        "button",
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-8 pb-8 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-16 w-16 mx-auto place-items-center rounded-2xl bg-primary/15 mb-4", children: /* @__PURE__ */ jsx(ScanLine, { className: "h-8 w-8 text-primary-glow" }) }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Scan billet" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Simulation du scanner à l'entrée du stade." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "QR Payload (coller)" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              value: qrInput,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Gate ID" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: gateId,
              ...
              children: [
                /* @__PURE__ */ jsx("option", { value: "gate-c", children: "Gate C - Nord" }),
                /* @__PURE__ */ jsx("option", { value: "gate-e", children: "Gate E - Est" }),
                /* @__PURE__ */ jsx("option", { value: "gate-b", children: "Gate B - Sud" })
              ]
            }
          )
        ] })
      ...
      result && /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "grid place-items-center mb-3", children: resultIcon }),
            /* @__PURE__ */ jsx("h2", { className: "font-display text-xl font-semibold", children: result.message }),
            /* @__PURE__ */ jsxs("div", { className: "mt-3 space-y-1 text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                "Résultat :",
                " ",
                /* @__PURE__ */ jsx("span", { className: "font-mono font-semibold", children: result.result })
              ] }),
              result.ticket_id && /* @__PURE__ */ jsxs("div", { children: [
                "Ticket : ",
                /* @__PURE__ */ jsx("span", { className: "font-mono", children: result.ticket_id })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                "Scanné à :",
                " ",
                /* @__PURE__ */ jsx("span", { children: new Date(result.scanned_at).toLocaleTimeString("fr-FR") })
              ] })
            ] })
          ]
        }
...
function TransferModal({
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-end justify-center bg-background/80 px-3 pb-3 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md rounded-3xl border border-white/10 bg-background p-5 shadow-elevated", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Transférer un billet" }),
        /* @__PURE__ */ jsx("h2", { className: "mt-1 font-display text-lg font-semibold", children: ticketTitle })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    error && /* @__PURE__ */ jsx("div", { className: "mt-4 rounded-2xl bg-destructive/15 text-destructive px-4 py-3 text-sm", children: error }),
    !result ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { className: "mt-5", children: [
        /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Email du destinataire" }),
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsx(Send, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "email",
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-4 rounded-2xl bg-primary/10 p-4 text-xs text-muted-foreground", children: "Le destinataire recevra un code de transfert valable 24h. Il devra avoir un compte FanPass pour accepter le billet." }),
      /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-success/15 p-5 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm text-success font-semibold mb-2", children: "✅ Transfert initié" }),
        /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground mb-3", children: "Communiquez ce code au destinataire :" }),
        /* @__PURE__ */ jsx("div", { className: "font-mono text-2xl font-bold tracking-[0.2em] text-foreground", children: result.transfer_code }),
        /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: copyCode,
            ...
            children: [
              copied ? /* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-success" }) : /* @__PURE__ */ jsx(Copy, { className: "h-4 w-4" }),
...
function TicketView({ onNav }) {
  const { token } = useAuth();
  const [segment, setSegment] = useState("wallet");
  const [tickets, setTickets] = useState([INITIAL_TICKET]);
  const [catalogEvents, setCatalogEvents] = useState(ALL_EVENTS);
  ...
  if (showScan) {
    return /* @__PURE__ */ jsx(ScanView, { onBack: () => setShowScan(false) });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsx(SectionTitle, { eyebrow: "Smart Ticketing", title: "Billets sécurisés" }),
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-primary-glow p-5 text-primary-foreground shadow-elevated", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -right-16 -top-16 h-40 w-40 rounded-full bg-white/10 blur-2xl" }),
      /* @__PURE__ */ jsxs("div", { className: "relative flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs opacity-80", children: "Coupe du Monde 2030 - Maroc" }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-2xl font-semibold", children: "Le billet pilote le parcours" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm opacity-90", children: "QR unique, anti-fraude, contrôle d'accès et gate associée dans un seul wallet." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-white/15 p-3", children: /* @__PURE__ */ jsx(WalletCards, { className: "h-6 w-6" }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "relative mt-5 grid grid-cols-4 gap-2 text-center text-sm", children: [
        /* @__PURE__ */ jsx(Stat, { label: "Billets", value: tickets.length }),
        /* @__PURE__ */ jsx(Stat, { label: "Matchs", value: walletStats.matchCount }),
        /* @__PURE__ */ jsx(Stat, { label: "Zones", value: walletStats.zoneCount }),
        /* @__PURE__ */ jsx(Stat, { label: "Events", value: walletStats.eventCount })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 rounded-2xl bg-white/5 p-1", children: [
      /* @__PURE__ */ jsx(
        SegmentButton,
        {
    ...
    ) : /* @__PURE__ */ jsx(CatalogView, { events: visibleEvents, onCheckout: openCheckout }),
    ...
    checkoutEvent && selectedTier && /* @__PURE__ */ jsx(
      CheckoutModal,
      {
        event: checkoutEvent,
        selectedTier,
...
function Stat({ label, value }) {
  return /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/15 px-2 py-3", children: [
    /* @__PURE__ */ jsx("div", { className: "font-display text-xl font-semibold", children: value }),
    /* @__PURE__ */ jsx("div", { className: "label-xs opacity-75", children: label })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: getEventLabel(activeTicket.eventType) }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: activeTicket.title }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: activeTicket.subtitle })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "rounded-full bg-success/15 px-3 py-1 text-xs font-medium text-success", children: getStatusLabel(activeTicket.status) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-5 grid grid-cols-[1fr_auto] items-center gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-sm", children: [
          /* @__PURE__ */ jsx(TicketFact, { label: "Lieu", value: activeTicket.venue }),
          /* @__PURE__ */ jsx(
            TicketFact,
            {
              label: "Date",
          ...
          /* @__PURE__ */ jsx(TicketFact, { label: "Gate associée", value: activeTicket.gate }),
          /* @__PURE__ */ jsx(TicketFact, { label: "Zone / Tribune", value: activeTicket.tribune }),
          /* @__PURE__ */ jsx(TicketFact, { label: "Place / accès", value: activeTicket.seat })
        ] }),
        /* @__PURE__ */ jsx(QRTicket, { seed: activeTicket.qrSeed, sizeClassName: "w-32" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-5 grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsx(SecurityPill, { icon: Fingerprint, label: "QR unique" }),
        /* @__PURE__ */ jsx(SecurityPill, { icon: LockKeyhole, label: "Anti-copie actif" }),
        /* @__PURE__ */ jsx(SecurityPill, { icon: ScanLine, label: "Contrôle gate" }),
        /* @__PURE__ */ jsx(SecurityPill, { icon: ShieldCheck, label: "Billet sécurisé" })
      ] }),
      (activeTicket.qrRaw || activeTicket.apiId) && /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2", children: [
        activeTicket.qrRaw && /* @__PURE__ */ jsx(
          "button",
          {
        ...
        activeTicket.apiId && /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-5 rounded-2xl bg-white/5 px-4 py-3 text-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Contrôle d'accès" }),
          /* @__PURE__ */ jsx("span", { className: "text-right font-semibold", children: activeTicket.accessControl })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Code sécurité" }),
          /* @__PURE__ */ jsx("span", { className: "font-mono text-xs font-semibold", children: activeTicket.securityCode })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: "Règles liées au billet" }),
        activeTicket.accessRules.map((rule) => /* @__PURE__ */ jsxs(
          "div",
          {
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs px-1 text-muted-foreground", children: "Tous mes billets sécurisés" }),
      tickets.map((ticket) => /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: ticket.title }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: getEventLabel(ticket.eventType) }),
              /* @__PURE__ */ jsxs("div", { className: "mt-1 text-xs text-muted-foreground", children: [
                "x",
                ticket.quantity
              ] })
...
function TicketFact({ label, value }) {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: label }),
...
function SecurityPill({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 rounded-2xl bg-white/5 px-3 py-2", children: [
    /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 shrink-0 text-primary-glow" }),
...
function CatalogView({
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-3", children: events.map((event) => {
    const minPrice = Math.min(...event.tiers.map((tier) => tier.price));
    return /* @__PURE__ */ jsxs("article", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: getEventLabel(event.type) }),
          /* @__PURE__ */ jsx("h2", { className: "mt-1 font-display text-xl font-semibold", children: event.title }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: event.subtitle })
        ] }),
        /* @__PURE__ */ jsx(
          "span",
          {
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: event.description }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-3 text-sm", children: [
        /* @__PURE__ */ jsx(EventMeta, { icon: MapPin, label: event.venue }),
        /* @__PURE__ */ jsx(
          EventMeta,
          {
            icon: CalendarDays,
        ...
        /* @__PURE__ */ jsx(EventMeta, { icon: DoorOpen, label: event.access.gate }),
        /* @__PURE__ */ jsx(
          EventMeta,
          {
            icon: ShieldCheck,
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: "À partir de" }),
          /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold", children: formatMoney(minPrice, "MAD") })
        ] }),
        /* @__PURE__ */ jsxs(
          "button",
          {
...
function EventMeta({ icon: Icon, label }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 rounded-2xl bg-white/5 px-3 py-2", children: [
    /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 shrink-0 text-primary-glow" }),
    /* @__PURE__ */ jsx("span", { className: "min-w-0 text-xs text-muted-foreground", children: label })
  ] });
}
function CheckoutModal({
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-end justify-center bg-background/80 px-3 pb-3 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md rounded-3xl border border-white/10 bg-background p-5 shadow-elevated", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "label-xs text-primary-glow", children: [
          "Achat ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-2xl bg-primary/10 p-4 text-sm", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 font-semibold text-primary-glow", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-5 space-y-2", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: "Catégorie" }),
      event.tiers.map((tier) => {
        ...
        return /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: tier.name }),
                /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: tier.benefits.join(" - ") })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "text-right text-sm font-semibold", children: formatMoney(tier.price, tier.currency) })
            ] })
          },
          tier.id
        );
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-5 flex items-center justify-between rounded-2xl bg-white/5 px-4 py-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: "Quantité" }),
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: "Maximum 4 billets" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-7 text-center font-display text-lg font-semibold", children: quantity }),
        /* @__PURE__ */ jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-5 rounded-2xl bg-primary/15 p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-sm", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "font-semibold", children: formatMoney(total, selectedTier.currency) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-3 flex items-center gap-2 text-xs text-primary-glow", children: [
        /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }),
        "Le QR et les règles d'accès seront ajoutés au wallet."
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-5 grid grid-cols-[auto_1fr_auto] gap-2", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: onClose,
      ...
      /* @__PURE__ */ jsx("div", { className: "grid place-items-center rounded-2xl bg-white/5 px-4 py-3", children: /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-muted-foreground" }) })
    ] })
  ] }) });
}
function QuickAction({
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 text-primary-glow" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: label }),
          /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: "Ouvrir" })
        ] })
      ]
    }
  );
...
function HeroBanner({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "absolute -right-20 -top-20 h-48 w-48 rounded-full bg-white/10 blur-2xl" }),
        /* @__PURE__ */ jsxs("div", { className: "relative flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "label-xs opacity-80", children: eyebrow }),
            /* @__PURE__ */ jsx("h2", { className: "mt-1 font-display text-2xl font-semibold", children: title }),
            /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm opacity-90", children: subtitle })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-white/15", children: /* @__PURE__ */ jsx(Icon, { className: "h-6 w-6" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "relative mt-5 grid grid-cols-3 gap-2 text-center text-sm", children: stats.map((s) => /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/15 px-2 py-3", children: [
          /* @__PURE__ */ jsx("div", { className: "truncate font-display text-lg font-semibold", children: s.value }),
          /* @__PURE__ */ jsx("div", { className: "label-xs opacity-75", children: s.label })
        ] }, s.label)) })
      ]
    }
  );
...
function GateAwareMap({ plan, gateCode }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative mt-4 h-80 overflow-hidden rounded-2xl border border-white/5", children: [
    /* @__PURE__ */ jsxs(
      MapContainer,
      {
        center,
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(FitBounds, { bounds }),
          /* @__PURE__ */ jsx(Marker, { position: dest, icon: gateIcon, children: /* @__PURE__ */ jsxs(Popup, { children: [
            "Gate ",
            gateCode
          ] }) }),
          /* @__PURE__ */ jsx(Marker, { position: dropoff, icon: dropoffIcon, children: /* @__PURE__ */ jsx(Popup, { children: "Drop-off" }) }),
          userPos && /* @__PURE__ */ jsx(Marker, { position: userPos, icon: userIcon, children: /* @__PURE__ */ jsx(Popup, { children: "Vous" }) }),
          route && route.length >= 2 && /* @__PURE__ */ jsx(
            Polyline,
            {
              positions: route,
    ...
    /* @__PURE__ */ jsx("div", { className: "glass absolute bottom-3 left-3 rounded-lg px-2 py-1 text-xs z-[1000]", children: userPos ? "Vous" : "Pos. approx." }),
    /* @__PURE__ */ jsxs("div", { className: "absolute left-3 top-3 rounded-lg bg-destructive/20 px-2 py-1 text-xs text-destructive z-[1000]", children: [
      plan.closed_roads.length,
      " routes fermées"
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "glass absolute right-3 top-3 rounded-lg px-2 py-1 text-xs z-[1000]", children: [
      "Gate ",
      gateCode
    ] }),
    routeInfo && /* @__PURE__ */ jsx("div", { className: "absolute bottom-3 right-3 rounded-lg bg-primary/15 px-2 py-1 text-xs text-primary-glow z-[1000]", children: routeInfo })
  ] });
}
...
function ItineraireSection() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("div", { className: "space-y-4", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "glass rounded-3xl p-6 animate-pulse space-y-3",
        children: [
          /* @__PURE__ */ jsx("div", { className: "h-4 w-2/3 bg-white/5 rounded-lg" }),
          /* @__PURE__ */ jsx("div", { className: "h-3 w-full bg-white/5 rounded-lg" })
        ]
      },
      i
    )) });
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Mode de transport" }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-2", children: modes.map((mode) => {
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: plan.headline }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: plan.destination_label }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
            "Gate ",
            gateCode,
      ...
      /* @__PURE__ */ jsx(GateAwareMap, { plan, gateCode })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Routes fermées" }),
      /* @__PURE__ */ jsx("div", { className: "space-y-2", children: plan.closed_roads.map((r) => /* @__PURE__ */ jsxs(
        "div",
        {
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Points de contrôle" }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        plan.checkpoints.map((cp, i) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: "flex items-center gap-3 rounded-2xl bg-white/5 px-3 py-3 text-sm",
            children: [
              /* @__PURE__ */ jsx("span", { className: "grid h-7 w-7 place-items-center rounded-full bg-primary/15 text-xs font-semibold text-primary-glow", children: i + 1 }),
              cp
            ]
          },
          cp
        )),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-2xl bg-success/10 px-3 py-3 text-sm", children: [
          /* @__PURE__ */ jsx(DoorOpen, { className: "h-4 w-4 text-success" }),
          "Gate ",
          gateCode,
          " — Scan QR"
        ] })
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-primary-glow p-5 text-primary-foreground shadow-elevated", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs opacity-80 mb-2", children: "Départ recommandé" }),
        /* @__PURE__ */ jsx("div", { className: "font-display text-5xl font-bold", children: departure }),
        /* @__PURE__ */ jsxs("div", { className: "mt-2 text-sm opacity-90", children: [
          "Match à ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 grid grid-cols-3 gap-2 text-xs", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/15 px-2 py-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "font-semibold", children: [
              plan.estimated_time_min,
              " min"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "opacity-75", children: "Trajet" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/15 px-2 py-2", children: [
            /* @__PURE__ */ jsx("div", { className: "font-semibold", children: "9 min" }),
            /* @__PURE__ */ jsx("div", { className: "opacity-75", children: "Marche" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/15 px-2 py-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "font-semibold", children: [
              plan.gate_wait_min,
            ...
            /* @__PURE__ */ jsx("div", { className: "opacity-75", children: "Attente" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs px-1 text-muted-foreground", children: "Alertes temps réel" }),
      alerts.map((a) => /* @__PURE__ */ jsx(AC, { alert: a }, a.id))
    ] }),
    /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 place-items-center rounded-2xl bg-success/15", children: /* @__PURE__ */ jsx(RefreshCw, { className: "h-6 w-6 text-success" }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-success", children: "Retour après match" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm font-semibold", children: plan.return_plan }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Porte alternative" }),
      /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm font-semibold", children: plan.alternative_gate }),
      /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
    ...
    guidanceStarted && /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 ring-1 ring-success/20", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-success", children: "Guidage actif" }),
      /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm font-semibold", children: [
        "Direction ",
...
function RC({
  ...
  return /* @__PURE__ */ jsx("div", { className: "glass rounded-2xl p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
    /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(I, { className: "h-6 w-6 text-primary-glow" }) }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: eyebrow }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm font-semibold", children: title }),
...
function AC({ alert }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "glass rounded-2xl p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
    /* @__PURE__ */ jsx("div", { className: `grid h-9 w-9 place-items-center rounded-xl ${tc}`, children: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-5 w-5" }) }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: alert.title }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: alert.detail })
    ] })
  ] }) });
}
const STADIUM_GATES = [
...
function GateSection() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Gate recommandée" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 font-display text-xl font-semibold", children: [
            activeGate.id,
            " - ",
            activeGate.zone
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-3 gap-2 text-center text-sm", children: [
        /* @__PURE__ */ jsx(HeroStat, { label: "Attente", value: `${activeGate.wait} min` }),
        /* @__PURE__ */ jsx(HeroStat, { label: "État", value: statusLabel$1(activeGate.status) }),
        /* @__PURE__ */ jsx(HeroStat, { label: "Zone", value: activeGate.zone })
      ] }),
      /* @__PURE__ */ jsx(
        StadiumMap,
        {
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs px-1 text-muted-foreground", children: "État des gates" }),
      STADIUM_GATES.map((gate) => /* @__PURE__ */ jsx(
        GateRow,
        {
          gate,
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs px-1 text-muted-foreground", children: "Notifications d'accès" }),
      /* @__PURE__ */ jsx(
        AccessNotice,
        {
          icon: Bell,
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Profil d'accès" }),
    ...
    showQr && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-end justify-center bg-background/80 px-3 pb-3 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md rounded-3xl border border-white/10 bg-background p-5 shadow-elevated", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "QR d'acces stade" }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: ticket.title }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
            activeGate.id,
            " - ",
            ticket.venue
...
function HeroStat({ label, value }) {
  return /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/5 px-2 py-3", children: [
    /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold", children: value }),
    /* @__PURE__ */ jsx("div", { className: "label-xs opacity-75 text-muted-foreground", children: label })
  ] });
}
function StadiumMap({
  activeGateId,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative mt-4 h-56 overflow-hidden rounded-2xl border border-white/5 bg-gradient-to-br from-[#0a1a33] to-[#102a55]", children: [
    /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 300 220", className: "absolute inset-0 h-full w-full", children: [
      /* @__PURE__ */ jsx(
        "ellipse",
        {
          cx: "150",
      ...
      /* @__PURE__ */ jsx("rect", { x: "118", y: "89", width: "64", height: "42", rx: "12", fill: "#1A6FE8" }),
      /* @__PURE__ */ jsx(
        "text",
        {
          x: "150",
      ...
      /* @__PURE__ */ jsx("circle", { cx: "214", cy: "160", r: "28", fill: "#73B9FF", opacity: "0.11" }),
      /* @__PURE__ */ jsx("circle", { cx: "235", cy: "80", r: "22", fill: "#00C48C", opacity: "0.11" }),
      /* @__PURE__ */ jsx(
        "path",
        {
      ...
      gatePoints.map((gate) => {
        ...
        return /* @__PURE__ */ jsxs("g", { children: [
          /* @__PURE__ */ jsx("circle", { cx: gate.x, cy: gate.y, r: active ? 11 : 8, fill: color, children: active && /* @__PURE__ */ jsx(
            "animate",
            {
              attributeName: "r",
              values: "11;15;11",
    ...
    /* @__PURE__ */ jsx("div", { className: "glass absolute bottom-3 left-3 rounded-lg px-2 py-1 text-xs", children: "Vous" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-3 right-3 rounded-lg bg-primary/20 px-2 py-1 text-xs text-primary-glow", children: "Gate active" })
  ] });
}
function GateRow({
  gate,
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: gate.status === "ferme" ? "Indispo" : `${gate.wait} min` })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-3 text-xs text-muted-foreground", children: gate.note })
      ]
    }
  );
}
function ServiceCard({
  ...
  return /* @__PURE__ */ jsx("div", { className: "glass rounded-2xl p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 text-primary-glow" }) }),
...
function ProfileLine({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3 rounded-2xl bg-white/5 px-3 py-3 text-sm", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 text-primary-glow" }),
      /* @__PURE__ */ jsx("span", { children: label })
    ] }),
    /* @__PURE__ */ jsx("span", { className: "text-right text-xs text-muted-foreground", children: value })
  ] });
}
const SUB_TABS$1 = [
...
function ParcoursView() {
  const [subTab, setSubTab] = useState("itineraire");
  const ticket = useActiveTicket();
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsx(
      HeroBanner,
    ...
    /* @__PURE__ */ jsx(FilterBar, { items: SUB_TABS$1, activeId: subTab, onChange: setSubTab }),
    subTab === "itineraire" ? /* @__PURE__ */ jsx(ItineraireSection, {}) : /* @__PURE__ */ jsx(GateSection, {})
  ] });
}
function MetaBadge({
  icon: Icon,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 rounded-2xl bg-white/5 px-3 py-2", children: [
    /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 shrink-0 text-primary-glow" }),
    /* @__PURE__ */ jsx("span", { className: "min-w-0 truncate text-xs text-muted-foreground", children: label })
  ] });
}
...
function GroupesSection() {
  ...
  if (loading)
    return /* @__PURE__ */ jsx("div", { className: "space-y-4", children: [...Array(3)].map((_, i) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "glass rounded-3xl p-6 animate-pulse space-y-3",
        children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(BadgeCheck, { className: "h-5 w-5 text-primary-glow" }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Contexte" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: ticket.title }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
          ticket.venue,
          " · ",
          ticket.date,
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 rounded-2xl bg-white/5 p-1", children: TABS.map((t) => /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => setTab(t.id),
    ...
    bestMatch && /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 ring-1 ring-success/20", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 text-success" }),
        /* @__PURE__ */ jsx("span", { className: "label-xs text-success", children: "Meilleure correspondance" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-display text-xl font-semibold", children: bestMatch.name }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid h-14 w-14 place-items-center rounded-2xl bg-success/15 text-success", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "font-display text-lg font-semibold", children: [
            bestMatch.score,
            "%"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "label-xs", children: "fit" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsx(MetaBadge, { icon: MapPin, label: bestMatch.meet_point }),
        /* @__PURE__ */ jsx(MetaBadge, { icon: Clock, label: `Départ ${bestMatch.meet_time}` }),
        /* @__PURE__ */ jsx(MetaBadge, { icon: Languages, label: bestMatch.language }),
        /* @__PURE__ */ jsx(
          MetaBadge,
          {
            icon: Users,
    ...
    tab !== "tous" && /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-primary/10 px-4 py-3 text-sm text-primary-glow", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: filtered.map((g) => /* @__PURE__ */ jsx(
      GroupCard,
      {
        group: g,
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Après le match" }),
      /* @__PURE__ */ jsx("div", { className: "space-y-2", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(r.icon, { className: "h-4 w-4 mt-0.5 text-primary-glow shrink-0" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: r.title }),
              /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: r.detail })
            ] })
          ]
        },
        r.title
    ...
    "article",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxs("span", { className: "label-xs rounded-full bg-white/5 px-2 py-1 text-muted-foreground", children: [
                group.team,
                " · ",
                group.language
              ] }),
              group.verified && /* @__PURE__ */ jsxs("span", { className: "label-xs rounded-full bg-success/15 px-2 py-1 text-success flex items-center gap-1", children: [
                /* @__PURE__ */ jsx(BadgeCheck, { className: "h-3 w-3" }),
                " Vérifié"
              ] })
            ] }),
            /* @__PURE__ */ jsx("h2", { className: "mt-3 font-display text-lg font-semibold", children: group.name }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: group.match })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "grid h-14 w-14 place-items-center rounded-2xl bg-success/15 text-success", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxs("div", { className: "font-display text-lg font-semibold", children: [
              group.score,
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2 text-xs", children: [
          /* @__PURE__ */ jsx(MetaBadge, { icon: MapPin, label: group.meet_point }),
          /* @__PURE__ */ jsx(MetaBadge, { icon: CalendarDays, label: group.meet_time }),
          /* @__PURE__ */ jsx(MetaBadge, { icon: Navigation, label: group.destination }),
          /* @__PURE__ */ jsx(MetaBadge, { icon: Sparkles, label: group.event_rec })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-2xl bg-white/5 p-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Capacité" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-2 h-1.5 overflow-hidden rounded-full bg-white/5", children: /* @__PURE__ */ jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-2", children: [
          /* @__PURE__ */ jsx(IL, { icon: ShieldCheck, text: group.safety }),
          /* @__PURE__ */ jsx(IL, { icon: Navigation, text: group.route }),
          /* @__PURE__ */ jsx(IL, { icon: Users, text: `Profils: ${group.profiles.join(", ")}` }),
          /* @__PURE__ */ jsx(
            IL,
            {
              icon: MapPin,
...
function IL({ icon: I, text }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2 text-xs text-muted-foreground", children: [
    /* @__PURE__ */ jsx(I, { className: "mt-0.5 h-3.5 w-3.5 shrink-0 text-primary-glow" }),
...
function CreateGroupModal({
  ...
  if (created)
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "h-20 w-20 rounded-full bg-success/15 grid place-items-center", children: /* @__PURE__ */ jsx(BadgeCheck, { className: "h-10 w-10 text-success" }) }),
      /* @__PURE__ */ jsx("h2", { className: "font-display text-xl font-semibold", children: "Groupe créé !" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Créer un groupe" }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-6 pb-8 space-y-5", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Nom du groupe" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            value: name,
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Équipe" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: team,
              ...
              children: [
                /* @__PURE__ */ jsx("option", { children: "Maroc" }),
                /* @__PURE__ */ jsx("option", { children: "France" }),
                /* @__PURE__ */ jsx("option", { children: "Bresil" }),
                /* @__PURE__ */ jsx("option", { children: "Espagne" }),
                /* @__PURE__ */ jsx("option", { children: "Neutre" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Langue" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: language,
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("option", { children: "EN" }),
                /* @__PURE__ */ jsx("option", { children: "ES" }),
                /* @__PURE__ */ jsx("option", { children: "AR" })
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Ambiance" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-1 rounded-2xl bg-white/5 p-1", children: ["festive", "calme", "familiale", "sociale", "tourisme"].map(
          (a) => /* @__PURE__ */ jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Point de rendez-vous" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            value: meetPoint,
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Heure de rendez-vous" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              value: meetTime,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Capacité max" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              value: capacity,
      ...
      /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-primary/10 p-4 text-xs text-muted-foreground", children: "Votre groupe sera soumis à vérification avant d'apparaître dans les recommandations." })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "label-xs text-primary-glow", children: catLabel(selected.category) }),
            selected.is_official && /* @__PURE__ */ jsxs("span", { className: "label-xs rounded-full bg-success/15 px-2 py-1 text-success flex items-center gap-1", children: [
              /* @__PURE__ */ jsx(BadgeCheck, { className: "h-3 w-3" }),
              " Officiel"
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: selected.title }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
            selected.subtitle,
            " · ",
            selected.city
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: selected.description }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2 text-xs", children: [
        /* @__PURE__ */ jsx(MetaBadge, { icon: MapPin, label: selected.venue }),
        /* @__PURE__ */ jsx(
          MetaBadge,
          {
            icon: CalendarDays,
        ...
        /* @__PURE__ */ jsx(MetaBadge, { icon: Ticket, label: selected.price }),
        /* @__PURE__ */ jsx(MetaBadge, { icon: Flame, label: `Capacité ${selected.capacity}%` })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-4 h-1.5 overflow-hidden rounded-full bg-white/5", children: /* @__PURE__ */ jsx(
        "div",
        {
    ...
    routePreview && /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 ring-1 ring-primary/20", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Itineraire event" }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: routePreview.title }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: routePreview.detail }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: filtered.map((e) => {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "grid h-11 w-11 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(I, { className: "h-5 w-5 text-primary-glow" }) }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: catLabel(e.category) }),
                      /* @__PURE__ */ jsx("h2", { className: "mt-1 font-display text-lg font-semibold", children: e.title }),
                      /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: e.subtitle })
                    ] })
                  ] }),
                  linked && /* @__PURE__ */ jsx("span", { className: "label-xs rounded-full bg-success/20 px-2 py-1 text-success", children: "Lié au billet" })
                ] }),
                /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: e.description }),
                /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2 text-xs", children: [
                  /* @__PURE__ */ jsx(MetaBadge, { icon: MapPin, label: e.venue }),
                  /* @__PURE__ */ jsx(
                    MetaBadge,
                    {
                      icon: CalendarDays,
                  ...
                  /* @__PURE__ */ jsx(MetaBadge, { icon: Ticket, label: e.price }),
                  /* @__PURE__ */ jsx(MetaBadge, { icon: Users, label: e.partners.join(", ") })
                ] })
              ]
            }
          )
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-4 space-y-2", children: selected.program.map((s) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex items-center gap-3 rounded-2xl bg-white/5 px-3 py-3 text-sm",
          children: [
            /* @__PURE__ */ jsx(Clock, { className: "h-4 w-4 text-primary-glow" }),
            s
          ]
        },
        s
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      ...
      /* @__PURE__ */ jsx(IC, { icon: ShoppingBag, title: "Merch", detail: selected.merch }),
      /* @__PURE__ */ jsx(IC, { icon: Navigation, title: "Accès", detail: selected.route }),
      /* @__PURE__ */ jsx(
        IC,
        {
          icon: Star,
...
function IC({
  ...
  return /* @__PURE__ */ jsx("div", { className: "glass rounded-2xl p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
    /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(I, { className: "h-5 w-5 text-primary-glow" }) }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: title }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: detail })
    ] })
...
function CommunauteView() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsx(FilterBar, { items: SUB_TABS, activeId: subTab, onChange: setSubTab }),
    subTab === "groupes" ? /* @__PURE__ */ jsx(GroupesSection, {}) : /* @__PURE__ */ jsx(EvenementsSection, {})
  ] });
}
const PICKUPS$1 = {
  stadium: "Stade",
...
function PanierView({
  ...
  if (order) {
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
      /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Confirmation" }),
        /* @__PURE__ */ jsx("div", { className: "w-16" })
      ] }) }),
      /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-10 pb-8 flex flex-col items-center justify-center text-center space-y-6", children: [
        /* @__PURE__ */ jsx("div", { className: "h-20 w-20 rounded-full bg-success/15 grid place-items-center", children: /* @__PURE__ */ jsx(Check, { className: "h-10 w-10 text-success" }) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl font-semibold", children: "Commande confirmée !" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: order.order_id })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-6 w-full text-center space-y-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3", children: [
            /* @__PURE__ */ jsx(QrCode, { className: "h-8 w-8 text-primary-glow" }),
            /* @__PURE__ */ jsx("span", { className: "font-mono text-lg font-semibold", children: order.qr_code })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted-foreground", children: [
            "Retrait : ",
            order.pickup_location
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-sm text-primary-glow font-semibold", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Mon panier" }),
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-6 pb-8 space-y-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Mode de retrait" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-1 rounded-2xl bg-white/5 p-1", children: Object.entries(PICKUPS$1).map(([k, v]) => /* @__PURE__ */ jsx(
          "button",
          {
      ...
      items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-8 text-center", children: [
        /* @__PURE__ */ jsx(ShoppingCart, { className: "h-10 w-10 text-muted-foreground mx-auto mb-3" }),
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Votre panier est vide" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: onBack,
      ...
      ] }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: items.map((item) => /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "h-full w-full grid place-items-center", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-white", children: item.visual.label }) })
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: item.name }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 text-xs text-muted-foreground", children: [
            fmt$1(item.price),
            " / unité"
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "w-6 text-center text-sm font-semibold", children: item.qty }),
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => onChangeQty(item.id, item.qty + 1),
        ...
        /* @__PURE__ */ jsx("div", { className: "text-right", children: /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold text-primary-glow", children: fmt$1(item.price * item.qty) }) })
      ] }) }, item.id)) }),
      items.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
        error && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-destructive/15 px-4 py-3 text-sm text-destructive", children: error }),
        /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Sous-total" }),
            /* @__PURE__ */ jsx("span", { className: "font-semibold", children: fmt$1(subtotal) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center justify-between text-sm", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: "Retrait" }),
            /* @__PURE__ */ jsx("span", { className: "text-success", children: "Gratuit" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "mt-3 pt-3 border-t border-white/5 flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Total" }),
            /* @__PURE__ */ jsx("span", { className: "font-display text-xl font-semibold text-primary-glow", children: fmt$1(subtotal) })
          ] })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
...
function MerchSection({ onBack }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Merchandising" }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Boutique fan" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "grid h-11 w-11 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(BadgePercent, { className: "h-5 w-5 text-primary-glow" }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Recommandé pour vous" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: ticket.title }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
    ...
    cartCount > 0 && /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(ShoppingCart, { className: "h-5 w-5 text-primary-glow" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "text-sm font-semibold", children: [
                cartCount,
                " article",
              ...
              /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: fmt(cart.reduce((s, i) => s + i.price * i.qty, 0)) })
            ] })
          ] }),
          /* @__PURE__ */ jsx("span", { className: "label-xs text-primary-glow", children: "Voir le panier →" })
        ]
      }
    ),
    /* @__PURE__ */ jsx(FilterBar, { items: FILTERS, activeId: filter, onChange: setFilter }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: filtered.map((p) => /* @__PURE__ */ jsxs("article", { className: "glass rounded-3xl p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[80px_1fr] gap-4", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 grid place-items-center", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl bg-black/20 px-2 py-1 text-xs font-bold text-white", children: p.visual.label }) })
          }
        ),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between gap-2", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsx("span", { className: "label-xs text-primary-glow", children: p.badge }) }),
            /* @__PURE__ */ jsx("h2", { className: "mt-1 font-display text-base font-semibold leading-tight", children: p.name })
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold text-primary-glow", children: fmt(p.price) }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground", children: [
                /* @__PURE__ */ jsx(Star, { className: "h-3 w-3 fill-primary-glow text-primary-glow" }),
                p.rating,
                " · ",
                p.team
              ] })
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 inline mr-1" }),
                  "Ajouter"
                ]
              }
            )
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-3 rounded-2xl bg-white/5 p-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs font-medium", children: [
          /* @__PURE__ */ jsx(BadgePercent, { className: "h-4 w-4 text-primary-glow" }),
          p.promo
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-2 flex flex-wrap gap-1", children: p.pickup.map((pk) => /* @__PURE__ */ jsx(
          "span",
          {
...
function SafetySection({ onBack }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Safety & Assistance" }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Aide supporter" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between gap-4", children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Contexte actif" }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: ticket.title }),
      /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
        ticket.venue,
        " - ",
    ...
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "grid h-14 w-14 place-items-center rounded-2xl bg-white/15", children: /* @__PURE__ */ jsx(Siren, { className: "h-7 w-7" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "font-display text-xl font-semibold", children: "Bouton aide urgent" }),
              /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm opacity-90", children: "Alerte staff avec ville, gate et billet actif." })
            ] })
          ] }),
          /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5 shrink-0" })
        ] })
      }
    ),
    latestRequest && /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Demande active" }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: latestRequest.title }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "rounded-full bg-success/15 px-3 py-1 text-xs font-medium text-success", children: statusLabel(latestRequest.status) })
      ] }),
      /* @__PURE__ */ jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: CONTACTS.map((contact) => {
        ...
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3", children: [
              ...
              /* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 opacity-80" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "mt-4 text-sm font-semibold", children: contact.title }),
            /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: contact.value }),
            /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs opacity-80", children: contact.detail })
          ]
        },
        contact.id
      );
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Assistance rapide" }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: "Que se passe-t-il ?" }),
      /* @__PURE__ */ jsx("div", { className: "mt-4 grid gap-2", children: ASSISTANCE_ACTIONS.map((action) => {
        ...
        return /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-primary/15", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 text-primary-glow" }) }),
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: action.title }),
                /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: action.detail })
              ] })
            ] })
          },
          action.type
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs px-1 text-muted-foreground", children: "Lieux utiles proches" }),
      nearbyPlaces.map((place) => {
        const Icon = placeIcon(place.type);
        return /* @__PURE__ */ jsxs("article", { className: "glass rounded-3xl p-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between gap-4", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 text-primary-glow" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: placeLabel(place.type) }),
              /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: place.name }),
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: place.detail })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-3 gap-2 text-xs", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 rounded-2xl bg-white/5 px-2 py-2", children: [
              /* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 shrink-0 text-primary-glow" }),
              /* @__PURE__ */ jsx("span", { className: "min-w-0 truncate text-muted-foreground", children: place.distance })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 rounded-2xl bg-white/5 px-2 py-2", children: [
              /* @__PURE__ */ jsx(Clock, { className: "h-3.5 w-3.5 shrink-0 text-primary-glow" }),
              /* @__PURE__ */ jsx("span", { className: "min-w-0 truncate text-muted-foreground", children: place.eta })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 rounded-2xl bg-white/5 px-2 py-2", children: [
              /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5 shrink-0 text-primary-glow" }),
              /* @__PURE__ */ jsx("span", { className: "min-w-0 truncate text-muted-foreground", children: place.open })
            ] })
          ] })
        ] }, place.id);
      })
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Alertes officielles" }),
      /* @__PURE__ */ jsx("div", { className: "mt-3 space-y-2", children: ALERTS.map((alert) => /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-white/5 p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: alert.title }),
            /* @__PURE__ */ jsx("span", { className: "label-xs text-muted-foreground", children: alert.time })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: alert.detail })
        ] })
      ] }) }, alert.id)) })
...
function PartnersSection({ onBack }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Partner Services" }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Services fan" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(Handshake, { className: "h-5 w-5 text-primary-glow" }) }),
      /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Contexte fan" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: ticket.title }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
          ticket.venue,
          " - ",
    ...
    latestBooking && /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Réservation active" }),
        /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: latestBooking.serviceName }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "rounded-full bg-success/15 px-3 py-1 text-xs font-medium text-success", children: latestBooking.status === "ready" ? "Prêt" : "Réservé" })
    ] }) }),
    /* @__PURE__ */ jsx(FilterBar, { items: FILTER_ITEMS, activeId: filter, onChange: setFilter }),
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Service sélectionné" }),
      /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-xl font-semibold", children: selectedService.name }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: selectedService.detail }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2 text-xs", children: [
        /* @__PURE__ */ jsx(MetaBadge, { icon: MapPin, label: selectedService.distance }),
        /* @__PURE__ */ jsx(MetaBadge, { icon: Clock, label: selectedService.eta }),
        /* @__PURE__ */ jsx(
          MetaBadge,
          {
            icon: CalendarDays,
        ...
        /* @__PURE__ */ jsx(MetaBadge, { icon: BadgePercent, label: selectedService.price })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded-2xl bg-white/5 p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm font-semibold", children: [
          /* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-primary-glow" }),
          " Connecté au parcours fan"
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-2 text-xs text-muted-foreground", children: selectedService.benefit })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: visibleServices.map((service) => {
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsx("h2", { className: "mt-1 font-display text-lg font-semibold", children: service.name }),
                        /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: service.partner })
                      ] })
                    ] }),
                    linked && /* @__PURE__ */ jsx("span", { className: "label-xs rounded-full bg-success/20 px-2 py-1 text-success", children: "Lié" })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: service.benefit }),
                  /* @__PURE__ */ jsxs("div", { className: "mt-4 grid grid-cols-2 gap-2 text-xs", children: [
                    /* @__PURE__ */ jsx(MetaBadge, { icon: MapPin, label: service.pickupHint }),
                    /* @__PURE__ */ jsx(MetaBadge, { icon: Clock, label: service.eta }),
                    /* @__PURE__ */ jsx(
                      MetaBadge,
                      {
                        icon: Star,
                    ...
                    /* @__PURE__ */ jsx(MetaBadge, { icon: BadgePercent, label: service.price })
                  ] })
                ]
              }
            ),
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Limites du service" }),
      /* @__PURE__ */ jsx("div", { className: "mt-3 space-y-2", children: selectedService.restrictions.map((r) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex items-center gap-2 rounded-2xl bg-white/5 px-3 py-3 text-xs",
          children: [
            /* @__PURE__ */ jsx(Check, { className: "h-4 w-4 shrink-0 text-success" }),
...
function PlusView() {
  ...
  if (section === "merch")
    return /* @__PURE__ */ jsx(MerchSection, { onBack: () => setSection(null) });
  if (section === "safety")
    return /* @__PURE__ */ jsx(SafetySection, { onBack: () => setSection(null) });
  if (section === "partners")
    return /* @__PURE__ */ jsx(PartnersSection, { onBack: () => setSection(null) });
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsx(
      HeroBanner,
      {
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(Icon, { className: "h-6 w-6 text-primary-glow" }) }),
        /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsx("span", { className: "label-xs text-primary-glow", children: tag }) }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 font-display text-lg font-semibold", children: title }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: detail })
        ] })
      ] })
    }
  );
...
function ProfileMain({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pb-8 pt-6 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsx("div", { className: "h-24 w-24 rounded-full bg-gradient-to-br from-primary via-primary to-primary-glow grid place-items-center text-3xl font-bold shadow-elevated", children: avatarInitials }),
          /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 rounded-full bg-success p-1.5 border-2 border-background", children: verified ? /* @__PURE__ */ jsx(BadgeCheck, { className: "h-5 w-5 text-success-foreground" }) : /* @__PURE__ */ jsx(ShieldCheck, { className: "h-5 w-5 text-primary-glow" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-semibold", children: "Mon Profil" }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(IdCard, { className: "h-6 w-6" })
            }
          ),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Fan ID" }),
            /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold", children: verified ? "Vérifié" : "En attente" })
          ] })
        ] }),
        !verified && /* @__PURE__ */ jsx(
          "button",
          {
            onClick: onVerify,
        ...
        verified && /* @__PURE__ */ jsx("span", { className: "label-xs rounded-full bg-success/20 px-2 py-1 text-success", children: "Actif" })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 space-y-3", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: onEdit,
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx(User, { className: "h-5 w-5 text-primary-glow" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Modifier mes informations" })
              ] }),
              /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-muted-foreground" })
            ]
          }
        ),
        !verified && /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: onVerify,
            className: "w-full flex items-center justify-between gap-3 rounded-2xl bg-white/5 p-4 text-left transition hover:bg-white/10",
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx(ShieldCheck, { className: "h-5 w-5 text-primary-glow" }),
                /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Créer mon Fan ID" })
              ] }),
              /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-muted-foreground" })
            ]
          }
      ...
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Pourquoi créer son Fan ID ?" }),
        /* @__PURE__ */ jsx("div", { className: "mt-4 space-y-3", children: [
          ...
          "div",
          {
            className: "flex items-center gap-3 rounded-2xl bg-white/5 px-3 py-3 text-sm",
            children: [
              /* @__PURE__ */ jsx(item.icon, { className: "h-4 w-4 text-primary-glow" }),
...
function ProfileEdit({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Modifier le profil" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: handleSave,
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pb-8 pt-6 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Langue préférée" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-4 gap-1 rounded-2xl bg-white/5 p-1", children: ["fr", "en", "es", "ar"].map((lang) => /* @__PURE__ */ jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Équipe supportée" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-1 rounded-2xl bg-white/5 p-1", children: ["Maroc", "France", "Bresil", "Espagne", "Neutre"].map(
            (team) => /* @__PURE__ */ jsx(
              "button",
              {
      ...
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-3", children: "Profil fan" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: p.label })
          },
          p.id
        )) })
      ] })
...
function FanIdVerification({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold", children: "Création Fan ID" }),
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pb-8 pt-6 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-primary-glow p-5 text-primary-foreground shadow-elevated", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute -right-16 -top-16 h-40 w-40 rounded-full bg-white/10 blur-2xl" }),
        /* @__PURE__ */ jsxs("div", { className: "relative text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "grid h-16 w-16 mx-auto place-items-center rounded-2xl bg-white/15 mb-4", children: /* @__PURE__ */ jsx(IdCard, { className: "h-8 w-8" }) }),
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl font-semibold", children: "Votre Fan ID" }),
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm opacity-90", children: "Le Fan ID est obligatoire pour accéder aux stades et fan zones officielles de la Coupe du Monde 2030." }),
          /* @__PURE__ */ jsx("div", { className: "mt-4 grid grid-cols-3 gap-2 text-center text-sm", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow mb-4", children: "Type de document" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-2", children: [
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: doc.label })
          },
          doc.id
        )) }),
        /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Numéro du document" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-primary/15", children: /* @__PURE__ */ jsx(Camera, { className: "h-6 w-6 text-primary-glow" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: "Photo du document" }),
            /* @__PURE__ */ jsx("div", { className: "mt-1 text-xs text-muted-foreground", children: "Prenez une photo claire de votre pièce d'identité." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("button", { className: "mt-4 w-full rounded-2xl border border-dashed border-white/15 bg-white/5 py-6 text-sm text-muted-foreground hover:bg-white/10 transition flex flex-col items-center gap-2", children: [
          /* @__PURE__ */ jsx(Camera, { className: "h-6 w-6" }),
          /* @__PURE__ */ jsx("span", { children: "Scanner le document" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("label", { className: "flex items-start gap-3 rounded-2xl bg-white/5 p-4 cursor-pointer", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: "Je certifie que les informations fournies sont exactes et j'accepte les conditions d'utilisation du Fan ID." })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: submitted ? /* @__PURE__ */ jsxs("span", { className: "flex items-center justify-center gap-2", children: [
            /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }),
            " Fan ID vérifié !"
...
function Field({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: label }),
    /* @__PURE__ */ jsx(
      "input",
      {
        type: "text",
...
function LoginView({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-12 pb-8 flex flex-col justify-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-16 w-16 mx-auto place-items-center rounded-2xl bg-primary/15 mb-4", children: /* @__PURE__ */ jsx(LogIn, { className: "h-8 w-8 text-primary-glow" }) }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-3xl font-semibold", children: "Connexion" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Connectez-vous à votre compte FanPass" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        error && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-destructive/15 text-destructive px-4 py-3 text-sm", children: error }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Email" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Mail, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "email",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Mot de passe" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(LockKeyhole, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }),
            /* @__PURE__ */ jsx(
              "input",
              {
...
function RegisterView({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pt-8 pb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsx("div", { className: "grid h-16 w-16 mx-auto place-items-center rounded-2xl bg-primary/15 mb-4", children: /* @__PURE__ */ jsx(UserPlus, { className: "h-8 w-8 text-primary-glow" }) }),
        /* @__PURE__ */ jsx("h1", { className: "font-display text-3xl font-semibold", children: "Inscription" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: step === 1 ? "Créez votre compte FanPass" : "Personnalisez votre profil supporter" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        error && /* @__PURE__ */ jsx("div", { className: "rounded-2xl bg-destructive/15 text-destructive px-4 py-3 text-sm", children: error }),
        step === 1 ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Prénom" }),
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(User, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Nom" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Téléphone" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "label-xs text-muted-foreground block mb-2", children: "Nationalité" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(Globe, { className: "absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "text",
          ...
          /* @__PURE__ */ jsx("div", { className: "glass rounded-3xl p-5 space-y-4", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "label-xs text-primary-glow mb-3", children: [
              /* @__PURE__ */ jsx(Star, { className: "inline h-3 w-3 mr-1" }),
              "Équipe supportée"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-1 rounded-2xl bg-white/5 p-1", children: TEAMS.map((team) => /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
            /* @__PURE__ */ jsxs("div", { className: "label-xs text-primary-glow mb-3", children: [
              /* @__PURE__ */ jsx(Users, { className: "inline h-3 w-3 mr-1" }),
              "Profil fan"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: PROFILES.map((p) => /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
...
function AppShell() {
  ...
  const [tab, setTab] = useState("billet");
  ...
  if (!mounted || isLoading) {
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
      /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 glass border-b border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md px-5 py-3 flex items-center justify-between", children: [
        /* @__PURE__ */ jsx("div", { className: "h-6 w-16 bg-white/5 rounded-lg animate-pulse" }),
        /* @__PURE__ */ jsx("div", { className: "h-6 w-20 bg-white/5 rounded-lg animate-pulse" }),
        /* @__PURE__ */ jsx("div", { className: "h-8 w-8 bg-white/5 rounded-full animate-pulse" })
      ] }) }),
      /* @__PURE__ */ jsx("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pb-28 pt-4 space-y-4", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-6 space-y-3", children: [
        /* @__PURE__ */ jsx("div", { className: "h-4 w-2/3 bg-white/5 rounded-lg animate-pulse" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-full bg-white/5 rounded-lg animate-pulse" }),
        /* @__PURE__ */ jsx("div", { className: "h-3 w-4/5 bg-white/5 rounded-lg animate-pulse" })
      ] }, i)) }),
      /* @__PURE__ */ jsx("nav", { className: "fixed bottom-0 inset-x-0 z-40 pb-4 pt-2 px-3", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-md glass rounded-2xl px-2 py-5 flex items-center justify-between shadow-elevated", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex-1 flex flex-col items-center gap-1.5",
          children: [
            /* @__PURE__ */ jsx("div", { className: "h-5 w-5 bg-white/5 rounded-lg animate-pulse" }),
            /* @__PURE__ */ jsx("div", { className: "h-3 w-8 bg-white/5 rounded-lg animate-pulse" })
          ]
        },
        i
      )) }) })
  ...
  if (showProfile) {
    return /* @__PURE__ */ jsx(ProfileView, { onClose: () => setShowProfile(false) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsx(TopBar, { onProfileClick: () => setShowProfile(true) }),
    /* @__PURE__ */ jsx("main", { className: "flex-1 mx-auto w-full max-w-md px-5 pb-28 pt-4", children: /* @__PURE__ */ jsxs("div", { className: "animate-float-up", children: [
      tab === "billet" && /* @__PURE__ */ jsx(TicketView, { onNav: setTab }),
      tab === "parcours" && /* @__PURE__ */ jsx(ParcoursView, {}),
      tab === "communaute" && /* @__PURE__ */ jsx(CommunauteView, {}),
      tab === "plus" && /* @__PURE__ */ jsx(PlusView, {})
    ] }, tab) }),
...
function Nav() {
  return /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-50", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "glass flex items-center justify-between rounded-2xl px-4 py-3", children: [
    /* @__PURE__ */ jsx(Logo, {}),
    /* @__PURE__ */ jsxs("nav", { className: "hidden md:flex items-center gap-8 text-sm text-muted-foreground", children: [
      ...
      /* @__PURE__ */ jsx("a", { href: "#app", className: "hover:text-foreground transition", children: "App" }),
      /* @__PURE__ */ jsx("a", { href: "#stadium", className: "hover:text-foreground transition", children: "Stadium" })
    ] }),
    /* @__PURE__ */ jsxs(
      Link,
      {
...
function Hero() {
  return /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-6 pt-20 pb-32 md:pt-32 md:pb-40", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl animate-float-up", children: [
      /* @__PURE__ */ jsxs("div", { className: "label-xs inline-flex items-center gap-2 rounded-full glass px-3 py-1.5 text-primary-glow", children: [
        /* @__PURE__ */ jsxs("span", { className: "relative flex h-2 w-2", children: [
          /* @__PURE__ */ jsx("span", { className: "absolute inline-flex h-full w-full rounded-full bg-primary opacity-75 animate-pulse-ring" }),
          /* @__PURE__ */ jsx("span", { className: "relative inline-flex h-2 w-2 rounded-full bg-primary" })
        ] }),
        "Coupe du Monde 2030 · Maroc"
      ] }),
      /* @__PURE__ */ jsxs("h1", { className: "mt-6 font-display text-5xl md:text-7xl font-700 leading-[1.05] tracking-tight", children: [
        "Votre match ",
        /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "commence" }),
        /* @__PURE__ */ jsx("br", {}),
        "avant le stade."
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-6 max-w-xl text-base md:text-lg text-muted-foreground", children: "Billets de matchs, pass fan zones, itinéraire en temps réel et navigation jusqu'à votre gate. Tout ce qu'il faut pour vivre le Maroc 2030 — sans friction." }),
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-12 grid grid-cols-3 gap-6 max-w-md", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "font-display text-2xl md:text-3xl font-semibold", children: s.v }),
        /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground mt-1", children: s.l })
      ] }, s.l)) })
    ] }) })
  ] });
}
function Problem() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "mx-auto max-w-7xl px-6 py-24", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Le problème" }),
      /* @__PURE__ */ jsxs("h2", { className: "mt-3 font-display text-3xl md:text-5xl font-semibold tracking-tight", children: [
        "Aller au stade ne devrait pas être",
        /* @__PURE__ */ jsx("br", {}),
        "une épreuve."
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mt-12 grid gap-4 md:grid-cols-3", children: items.map((it) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "glass rounded-2xl p-6 hover:translate-y-[-2px] transition",
        children: [
          /* @__PURE__ */ jsx(it.icon, { className: "h-6 w-6 text-destructive" }),
          /* @__PURE__ */ jsx("h3", { className: "mt-4 font-display text-lg font-semibold", children: it.title }),
...
function Solution() {
  return /* @__PURE__ */ jsx("section", { className: "mx-auto max-w-7xl px-6 py-24", children: /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-8 md:p-14 relative overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute -top-32 -right-32 h-72 w-72 rounded-full bg-primary/30 blur-3xl" }),
    /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-center relative", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "La solution" }),
        /* @__PURE__ */ jsxs("h2", { className: "mt-3 font-display text-3xl md:text-5xl font-semibold tracking-tight", children: [
          "Un seul pass.",
          /* @__PURE__ */ jsx("br", {}),
          "Toute l'expérience."
        ] }),
        /* @__PURE__ */ jsx("p", { className: "mt-5 text-muted-foreground max-w-md", children: "FanPass guide chaque fan en temps réel, du métro à son siège — et bien au-delà du sifflet final." }),
        /* @__PURE__ */ jsxs("div", { className: "mt-6 flex gap-3", children: [
          /* @__PURE__ */ jsx(Badge, { icon: ShieldCheck, children: "Sans contact" }),
          /* @__PURE__ */ jsx(Badge, { icon: Zap, children: "Temps réel" }),
          /* @__PURE__ */ jsx(Badge, { icon: Sparkles, children: "IA prédictive" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "relative grid place-items-center", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 grid place-items-center", children: /* @__PURE__ */ jsx("div", { className: "h-72 w-72 rounded-full border border-primary/20 animate-pulse-ring" }) }),
        /* @__PURE__ */ jsx(QRTicket, {})
      ] })
    ] })
  ] }) });
}
function Badge({
  ...
  return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-white/10 px-3 py-1 text-xs", children: [
    /* @__PURE__ */ jsx(Icon, { className: "h-3.5 w-3.5 text-primary-glow" }),
    " ",
    children
  ] });
}
function Features() {
  ...
  return /* @__PURE__ */ jsxs("section", { id: "features", className: "mx-auto max-w-7xl px-6 py-24", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-end justify-between flex-wrap gap-6", children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "Features" }),
      /* @__PURE__ */ jsxs("h2", { className: "mt-3 font-display text-3xl md:text-5xl font-semibold tracking-tight", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3", children: features.map((f, i) => /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(f.icon, { className: "h-6 w-6 text-primary-foreground" })
            }
          ),
          /* @__PURE__ */ jsx("h3", { className: "mt-5 font-display text-xl font-semibold", children: f.title }),
...
function AppPreview() {
  return /* @__PURE__ */ jsx("section", { id: "app", className: "mx-auto max-w-7xl px-6 py-24", children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-primary-glow", children: "L'app" }),
      /* @__PURE__ */ jsxs("h2", { className: "mt-3 font-display text-3xl md:text-5xl font-semibold tracking-tight", children: [
        "Une interface",
        /* @__PURE__ */ jsx("br", {}),
        "digne du futur du stade."
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-5 text-muted-foreground max-w-md", children: "Dark-mode dominant, micro-interactions fluides, navigation pensée pour le mobile. Creez votre compte fan pour tester l'app complete." }),
      /* @__PURE__ */ jsxs(
        Link,
        {
          to: "/app",
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-primary/20 blur-3xl rounded-full" }),
      /* @__PURE__ */ jsx(PhoneMock, {})
    ] })
  ] }) });
}
function PhoneMock() {
  return /* @__PURE__ */ jsx("div", { className: "relative mx-auto w-[280px] aspect-[9/19] rounded-[3rem] glass p-3 shadow-elevated", children: /* @__PURE__ */ jsxs("div", { className: "relative h-full w-full rounded-[2.4rem] bg-background overflow-hidden border border-white/5", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 inset-x-0 h-6 grid place-items-center", children: /* @__PURE__ */ jsx("div", { className: "h-1 w-16 rounded-full bg-white/20 mt-2" }) }),
    /* @__PURE__ */ jsxs("div", { className: "pt-10 px-5", children: [
      /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: "Billetterie 2030" }),
      /* @__PURE__ */ jsx("div", { className: "font-display text-lg font-semibold mt-1", children: "Maroc vs Espagne" }),
      /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: "Grand Stade Hassan II · 20:00 · Porte C" }),
      /* @__PURE__ */ jsx("div", { className: "mt-4 scale-90 origin-top", children: /* @__PURE__ */ jsx(QRTicket, { seed: 203014 }) }),
      /* @__PURE__ */ jsx("div", { className: "mt-4 grid grid-cols-3 gap-2 text-center", children: ["Tribune", "Rang", "Siège"].map((l, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white/5 p-2", children: [
        /* @__PURE__ */ jsx("div", { className: "label-xs text-muted-foreground", children: l }),
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold", children: ["B", "12", "47"][i] })
      ] }, l)) })
    ] })
  ] }) });
}
function FinalCTA() {
  return /* @__PURE__ */ jsx("section", { id: "stadium", className: "mx-auto max-w-7xl px-6 py-24", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl glass p-10 md:p-16 text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 opacity-40", children: /* @__PURE__ */ jsx(
      "img",
      {
        src: heroImg,
        alt: "",
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 -z-10 bg-gradient-to-b from-background/60 to-background/90" }),
    /* @__PURE__ */ jsxs("h2", { className: "font-display text-3xl md:text-6xl font-semibold tracking-tight max-w-3xl mx-auto", children: [
      "Le stade devient ",
      /* @__PURE__ */ jsx("span", { className: "text-gradient", children: "intelligent." })
    ] }),
    /* @__PURE__ */ jsx("p", { className: "mt-5 text-muted-foreground max-w-xl mx-auto", children: "Rejoignez la prochaine génération de supporters. Plus rapide, plus humain, plus connecté." }),
    /* @__PURE__ */ jsxs(
      Link,
      {
        to: "/app",
...
function Footer() {
  return /* @__PURE__ */ jsx("footer", { className: "mx-auto max-w-7xl px-6 py-10 border-t border-white/5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between flex-wrap gap-4", children: [
    /* @__PURE__ */ jsx(Logo, {}),
    /* @__PURE__ */ jsx("div", { className: "text-xs text-muted-foreground", children: "© 2030 FanPass — Smart Stadium Experience" })
  ] }) });
}
