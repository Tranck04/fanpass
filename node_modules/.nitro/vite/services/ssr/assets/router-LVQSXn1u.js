...
import { useState, useEffect, useCallback, createContext, useContext, useMemo, Suspense, lazy } from "react";
...
const GateAwareMap = lazy(
  () => import("./GateAwareMap-D66ostTx.js").then((m) => ({ default: m.GateAwareMap }))
);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "glass rounded-3xl p-5", children: [
      ...
      /* @__PURE__ */ jsx(
        Suspense,
        {
          fallback: /* @__PURE__ */ jsx("div", { className: "mt-4 h-80 rounded-2xl bg-white/5 animate-pulse flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: "Chargement de la carte..." }) }),
          children: /* @__PURE__ */ jsx(GateAwareMap, { plan, gateCode })
        }
      )
    ] }),
